alter table T_DOCUMENT add column DOC_GPA_C DOUBLE;;
alter table T_DOCUMENT add column DOC_AGE_C INT;;
alter table T_DOCUMENT add column DOC_GENDER_C varchar(500);
alter table T_DOCUMENT add column DOC_EXPERIENCE_C INT;;
